...
print -- "Preset: robust"
print -- "実行予定target session数を含む計画:"
...
print -- ""
read -r "CONFIRMATION?堅牢検証をローカルCPUで開始するには ROBUST と入力してください: "
if [[ "$CONFIRMATION" != "ROBUST" ]]; then
  print -- "キャンセルしました。"
  exit 0
fi

OUTPUT_BASE="artifacts/adaptive_placebo_validation"
CAPTURE_BASE="artifacts/adaptive_placebo_validation-launcher-logs"
