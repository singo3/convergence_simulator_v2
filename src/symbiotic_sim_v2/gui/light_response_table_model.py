"""Qt table model for Stage 7 formal-light receipt diagnostics."""
...
class LightResponseReceiptTableModel(QAbstractTableModel):
    """Display immutable receipt records without exposing provenance to physiology."""
