...
GARDEN_OUTPUT_MODEL_VERSION = "relax_with_light_garden_output_qualification_v0_1"
GARDEN_QUALIFICATION_STATE_SCHEMA_VERSION = "garden_qualification_state_v1"
DIGITAL_LIFE_TOUCH_SCHEMA_VERSION = "digital_life_touch_event_v1"
GARDEN_INTEROCEPTIVE_FEEDBACK_SCHEMA_VERSION = (
    "garden_interoceptive_feedback_event_v1"
)
GARDEN_QUALIFIED_B_SCHEMA_VERSION = "garden_qualified_b_event_v1"
...
STANDARD_DIGITAL_LIFE_IDS = ("life-blue", "life-green", "life-red")
...
class GardenOutputConfig:
    ...
    expected_digital_life_ids: tuple[str, str, str] = STANDARD_DIGITAL_LIFE_IDS
    ...
    def __post_init__(self) -> None:
        ...
        if normalized_ids != STANDARD_DIGITAL_LIFE_IDS:
            raise ValueError(
                "expected_digital_life_ids must contain the canonical IDs in lexical order"
            )
